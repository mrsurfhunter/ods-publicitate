        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-50 p-8">
          <div className="text-center max-w-md">
            <div className="w-16 h-16 bg-red-50 flex items-center justify-center mx-auto mb-6">
              <i className="fas fa-exclamation-triangle text-2xl text-brand"></i>
            </div>
            ...
            <button
              className="px-6 py-3 bg-brand text-white font-bold hover:bg-brand-dark border-2 border-brand transition-all"
