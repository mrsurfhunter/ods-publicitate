...
export const DEFAULT_ADDONS = [
  ...
  { id: "addon-banner", name: "Banner pe Site", icon: "fa-rectangle-ad",
    price: 1200, sub: 1000, unit: "/lună", multi: false, qtyPricing: null,
    desc: "Banner 300×250, ~1.5M afișări/lună, desktop + mobil", active: true },
  ...
  { id: "addon-event", name: "Acoperire Eveniment", icon: "fa-camera",
    price: 800, sub: null, unit: "/eveniment", multi: false, qtyPricing: null,
    desc: "Reporter + fotograf, articol live, galerie foto, 2 postări + 1 story", active: true },
];
