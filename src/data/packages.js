...
export const CONSULT_STEPS = [
  {
    ...
    options: [
      ...
      { id: "sanatate", label: "Sănătate / Wellness", icon: "\u{1FA7A}" },
  ...
  },
  {
    ...
    options: [
      { id: "more-clients", label: "Vreau mai mulți clienți", icon: "\u{1F4C8}" },
      { id: "brand", label: "Să fiu cunoscut în Sibiu", icon: "\u{2B50}" },
      { id: "event", label: "Promovez un eveniment sau o ofertă", icon: "\u{1F4E3}" },
      { id: "seo", label: "Să apar pe Google când caută lumea", icon: "\u{1F50D}" },
    ],
  },
  {
    id: "budget",
  ...
  },
  {
    ...
    options: [
      { id: "once", label: "O singură dată", icon: "1\uFE0F\u20E3" },
      { id: "few-months", label: "Câteva luni", icon: "\u{1F4C5}" },
